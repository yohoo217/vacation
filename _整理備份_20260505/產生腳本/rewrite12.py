...
# 1. Delete old Day 6 events
start_marker = r'\s*<div class="event">\s*<div class="time">Day 6 09:00</div>'
end_marker = r'結束這趟壯闊的道東之旅。</div>\s*</div>'

start_match = re.search(start_marker, content)
end_match = re.search(end_marker, content)

if start_match and end_match:
    content = content[:start_match.start()] + content[end_match.end():]
else:
    print("Could not find old Day 6 events to delete")

# 2. Insert new Day 6 card
day6_html = """
